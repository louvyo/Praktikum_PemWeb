...
<body>
    ...
    <div class="popup-container" id="registerPopup">
        <div class="popup register-popup">
            <span class="close-button" onclick="hideRegisterPopup()">X</span>
            <h2>Register</h2>
            <form action="register.php" method="post">
                <div class="form-group">
                    <label for="register-username"><i class="bx bxs-user"></i></label>
                    <input type="text" id="register-username" name="register-username" required autocomplete="off" placeholder="Username" />
                </div>
                <div class="form-group">
                    <label for="register-email"><i class="bx bxs-envelope"></i></label>
                    <input type="email" id="register-email" name="register-email" required placeholder="Email" />
                </div>
                <div class="form-group">
                    <label for="register-password"><i class="bx bxs-lock-alt"></i></label>
                    <input type="password" id="register-password" name="register-password" required placeholder="Password" />
                </div>
                <button type="submit" class="register-button" onclick="hideRegisterPopup()">Register</button>
            </form>
            <p>Already have an account? <a href="javascript:void(0);" onclick="showLoginPopup(), hideRegisterPopup()">Login</a></p>
        </div>
    </div>
        ...
        <div class="popup login-popup">
            ...
            <form action="admin_login.php" method="post" id="login-form">
                <div class="form-group">
                    ...
                    <input type="text" id="popup-username" name="popup-username" required autocomplete="off" placeholder="Username" />
                </div>
                <div class="form-group">
                    <label for="popup-password"><i class="bx bxs-lock-alt"></i></label>
                    <input type="password" id="popup-password" name="popup-password" required placeholder="Password" />
                </div>
            ...
            ?>
            <p>Don't have an account? <a href="javascript:void(0);" onclick="showRegisterPopup(), hideLoginPopup()">Register</a></p>
        </div>
    </div>
    ...
    <script>
        ...
        // Fungsi untuk menyembunyikan pop-up registrasi
